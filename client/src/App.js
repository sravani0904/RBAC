...
import ParentLogin from "./components/login/parentLogin/ParentLogin";
import ParentHome from "./components/parent/ParentHome";
import ParentProfile from "./components/parent/profile/Profile";
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/faculty/feedback" element={<FeedbackForm />} />
      <Route path="/signup" element={<Signup />} />
      ...
      {/* Parent */}
      <Route path="/login/parentlogin" element={<ParentLogin />} />
