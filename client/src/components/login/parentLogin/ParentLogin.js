...
import { parentSignIn } from "../../../redux/actions/parentActions";
...
const ParentLogin = () => {
  ...
  const login = (e) => {
    e.preventDefault();
    setLoading(true);
    dispatch(parentSignIn({ username: username, password: password }, navigate));
  };
    ...
    <div className="bg-[#51d665] h-screen w-screen flex items-center justify-center">
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          <h1 className="text-white text-3xl font-semibold">Parent</h1>
          ...
          <button
            ...
            className="w-32 hover:scale-105 transition-all duration-150 rounded-lg flex items-center justify-center text-blue-600 text-base py-1 bg-white">
            Sign Up
          </button>
          {loading && (
            <Spinner
