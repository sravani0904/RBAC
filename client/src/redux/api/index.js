...
export const adminSignup = (formData) => API.post("/api/admin/signup", formData);
...
export const getAllParent = () => API.get("/api/admin/getallparent");
...
export const deleteParent = (data) =>
  API.post("/api/admin/deleteparent", data);
...
export const facultySignup = (formData) =>
  API.post("/api/faculty/signup", formData);
...
export const studentSignup = (formData) =>
  API.post("/api/student/signup", formData);
...
// Parent
export const parentSignIn = (formData) => API.post("/api/parent/login", formData);
export const parentSignup = (formData) => API.post("/api/parent/signup", formData);
export const parentUpdatePassword = (updatedPassword) =>
  API.post("/api/parent/updatepassword", updatedPassword);
export const updateParent = (updatedParent) =>
  API.post("/api/parent/updateprofile", updatedParent);
export const getChildAttendance = (payload) =>
  API.post("/api/parent/child/attendance", payload);
export const getChildResults = (payload) =>
  API.post("/api/parent/child/results", payload);

// Communication & Feedback
export const sendFeedback = (payload) => API.post("/api/comm/feedback/send", payload);
export const listFeedback = () => API.get("/api/comm/feedback");
export const sendMessage = (payload) => API.post("/api/comm/message/send", payload);
export const listMessages = () => API.get("/api/comm/message");

// Auth: forgot/reset password
export const requestPasswordReset = (payload) => API.post("/api/auth/request-reset", payload);
export const resetPassword = (payload) => API.post("/api/auth/reset", payload);
